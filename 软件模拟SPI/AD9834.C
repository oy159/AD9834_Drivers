...

{
    ...
    GPIO_InitStruct.Pin = AD9834_FSYNC | AD9834_SCLK | AD9834_SDATA | AD9834_RESET; 
    ...
    GPIO_InitStruct.Pin = AD9834_FS | AD9834_PS;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP; 
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH; 
    HAL_GPIO_Init(AD9834_Control_Port ,&GPIO_InitStruct) ;
    

	HAL_GPIO_WritePin(GPIOB, AD9834_FS, GPIO_PIN_RESET);
	HAL_GPIO_WritePin(GPIOB, AD9834_PS, GPIO_PIN_RESET);
